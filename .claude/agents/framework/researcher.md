...
2. **Verify before relaying.** Version-sensitive facts (API signatures,
...
3. **Separate fact from inference.** Mark every conclusion you drew
...
4. **Disconfirm.** Before returning, spend one pass looking for
   ...
   is advocacy.
5. **Stop on diminishing returns.** If two more sources add nothing
